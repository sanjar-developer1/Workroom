      ...
      <ul>
        <router-link to="/dashboard" class="li">
          <img
            ...
            alt="bu yerda dashboard icon bor"
        ...
        <router-link to="/projects" class="li">
          <img
            ...
            alt="bu yerda projects icon bor"
            style="width: calc(24 / 13.6 * 1vw); height: calc(24 / 13.6 * 1vw)"
          />
          <p>Projects</p>
        </router-link>
        <router-link to="/calendar" class="li">
          <img
            ...
            alt="bu yerda calendar icon bor"
            style="width: calc(24 / 13.6 * 1vw); height: calc(24 / 13.6 * 1vw)"
          />
          <p>Calendar</p>
        </router-link>
        <router-link to="/vacations" class="li">
          <img
            src="../assets/images/vacitons.svg"
            alt="bu yerda vacations icon bor"
            style="width: calc(24 / 13.6 * 1vw); height: calc(24 / 13.6 * 1vw)"
          />
          <p>Vacations</p>
        </router-link>
        <router-link to="/employees" class="li">
          <img
            ...
            alt="bu yerda employees icon bor"
            style="width: calc(24 / 13.6 * 1vw); height: calc(24 / 13.6 * 1vw)"
          />
          <p>Employees</p>
        </router-link>
    ...
    <div class="sidebar-center">
      <div @click="modal" class="sidebar-center-support">
        <img
          ...
          alt="bu yerda support icon bor"
        />
        <button><i class="fa-regular fa-comment"></i>Support</button>
      </div>
      <router-link @click="logout" to="/" class="logout"
